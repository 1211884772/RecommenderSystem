 ...
 * @BelongsPackage: com.mumu.online
 * @Description: TODO
 * @Author: mumu
 * @CreateTime: 2023-01-22  15:19
 * @Version: 1.0
 */
...
object ConnHelper extends Serializable{
  //懒变量定义，使用的时候才初始化
  lazy val jedis=new Jedis("192.168.1.110")
  lazy val mongoClient = MongoClient(MongoClientURI("mongodb://192.168.1.110:27017/recommender"))
}
