 ...
 * @BelongsPackage: com.mumu.statistics
 * @Description: TODO
 * @Author: mumu
 * @CreateTime: 2023-01-21  12:08
 * @Version: 1.0
 */
...
object StatisticsRecommender {
  ...
  def main(args: Array[String]): Unit = {
    ...
    //createOrReplaceTempView 方式将读取的文件创建临时表ratingOfMonth
