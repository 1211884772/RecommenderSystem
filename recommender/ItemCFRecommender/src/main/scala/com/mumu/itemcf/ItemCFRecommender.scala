 ...
 * @BelongsPackage: com.mumu.itemcf
 * @Description: TODO
 * @Author: mumu
 * @CreateTime: 2023-01-24  02:26
 * @Version: 1.0
 */
...
object ItemCFRecommender {
  ...
  def main(args: Array[String]): Unit = {
    ...
    //统计每个商品的评分个数，按照productIdl来做group by
    ...
    //TODO:展示数据
    //joinedDF.show()
    //提取需要的数据，包装成（productId,(productId2,score)）
